...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
    <div class="w3-display-left w3-text-white" style="padding:48px">
        ...
        <div class="w3-center">
            ...
            <p><a href="https://github.com/Jahidul2543?tab=repositories"
                  class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">My GitHub
                </a></p>
